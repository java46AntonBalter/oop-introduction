...
public class PhotoSelector {
	...
	public static void main(String[] args){
		...
		selectPictures("All autumn pictures", ".*\\\\(\\d{4})(09|1[0-1]).*");
		selectPictures("All 2015 spring pictures", ".*\\\\(2015)(0[3-5]).*");
		...
		selectPictures("All pictures taken in dates with equal number of month and day", ".*\\\\(\\d{4})(0[0-9]|1[0-2])\\2_.*");
